...
public class LetterTileDrawable extends Drawable {
  ...
  private boolean isCJKLetter = false;
  ...
  private void drawLetterTile(final Canvas canvas) {
    ...
    if (letter != null) {
      ...
      paint.setTextSize(scale * letterToTileRatio * minDimension * (isCJKLetter ? 0.75f : 1f));
  ...
  private LetterTileDrawable setLetterAndColorFromContactDetails(
    ...
    } else if (!TextUtils.isEmpty(displayName) && com.android.contacts.common.TextUtils.isCJKLetter(displayName.charAt(0))) {
      letter = Character.toUpperCase(displayName.charAt(0));
      isCJKLetter = true;
    } else {
      letter = null;
